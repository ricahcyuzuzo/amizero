    ...
    <div className='w-full text-white flex flex-col-reverse md:flex-row justify-between'>
        <div className='px-6  flex flex-col justify-center py-6'>
            <div className=''>
                ...
                <Link to='/products' className='w-[100%] flex justify-center items-center mt-[40px] md:w-[200px] h-[50px] bg-[#f9e9e0] text-[#4D335E] text-[16px] font-medium rounded-lg'>Take a look</Link>
            </div>
        </div>
